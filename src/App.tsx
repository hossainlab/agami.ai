...
import { getLinkConfig, saveLinkConfig } from './utils/config';

export default function App() {
  const [linkConfig, setLinkConfig] = useState<LinkConfig>(getLinkConfig());
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans selection:bg-indigo-600 selection:text-white">
      ...
      <main className="flex-1">
        ...
        {/* 3. Interactive Curriculum Explorer (Modules 1–5) */}
        <CurriculumExplorer
          config={linkConfig}
        />

        {/* 4. Be a Mentor Section */}
        <MentorSection
          onOpenRegistration={handleOpenRegistration}
          config={linkConfig}
        />
